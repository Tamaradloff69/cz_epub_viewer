...
function setFontFamily(fontFamily) {
    ...
    console.log("Attempting to set font family...");

    if (rendition) {
        // Log the font that is being applied
        console.log("Rendition object found. Applying font: " + fontFamily);
        rendition.themes.override("font-family", fontFamily + " !important");
    } else {
        // Log an error if the rendition object isn't ready
        console.log("Error: Rendition object was not found when setFontFamily was called.");
    }
}
