...
function setFontFamily(fontFamily){
    console.log("Attempting to set font family to: " + fontFamily);
    if (rendition) {
        // This is the correct, forceful method to override the CSS property.
        rendition.themes.override("font-family", fontFamily + " !important");
        console.log("Font override applied.");
    } else {
