...
function applyReaderStyles(fontFamily, fontSize) {
    ...
    if (rendition) {
        // Define a new theme with rules for both font family and font size
        rendition.themes.register("customStyles", {
            "*": {
                "font-family": `${fontFamily} !important`,
                "font-size": `${fontSize}px !important`,
                // You can add other styles like line-height here in the future
                // "line-height": "1.5 !important",
            }
        });

        // Select the theme to apply it
        rendition.themes.select("customStyles");
