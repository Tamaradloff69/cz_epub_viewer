...
function setFontFamily(fontFamily) {
    console.log("Attempting to inject font family: " + fontFamily);
    if (rendition) {
        // Find the style tag we created in all sections of the book
        // and set its content to our new font rule.
        rendition.views().forEach(function(view) {
            var styleElement = view.document.getElementById("custom-font-style");
            if (styleElement) {
                // This rule is highly specific and should override everything
                styleElement.innerHTML = `* { font-family: "${fontFamily}" !important; }`;
            }
        });
        console.log("Font injection applied.");
    } else {
